...
<h1 align="center"> P2pro Technology Solution Pvt Ltd-"triggerring pipeline by Git pipeline jon 13th oct--> build check 123 automation" Very Good Training center for DevOps with AWS, Digital Marketing & Cyber Security's as well in Madhapur and we also providr Job Assitance Job Support....Teaching Real Time scnerios in all the technologies</h1>
<hr>
<br>
